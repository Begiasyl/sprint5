...
public class KarinaPage {
    ...
    @FindBy (xpath = "(//button[@class='MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium css-1comqtb'])[1]")
    public WebElement treeDots;

    @FindBy (xpath = "(//li[@class='MuiMenuItem-root MuiMenuItem-gutters MuiButtonBase-root css-3hn6xr'])[1]")
    public WebElement  PDFversion;

    @FindBy (xpath =  "(//button[@class='MuiButton-root MuiButton-text MuiButton-textPrimary MuiButton-sizeMedium MuiButton-textSizeMedium MuiButtonBase-root css-xkpeb'])[1]")
